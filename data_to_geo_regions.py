...
columns = ['sexo', 'idade', 'raca', 'branco',
       ...
       'filhos_nasc_vivos', 'vive_conjuge', 'estado_conj', '65_anos', 'casado', 'sit_setor_C', 'cond_ocup_B', 'ocup_propria',
...
df_reg_imediata["log_depositos_poupanca_deflacionada_per_capita"] = np.log(df_reg_imediata["depositos_poupanca_deflacionada_per_capita"])
df_reg_imediata["log_depositos_prazo_deflacionada_per_capita"] = np.log(df_reg_imediata["depositos_prazo_deflacionada_per_capita"])
df_reg_imediata["log_depositos_totais_deflacionada_per_capita"] = np.log(df_reg_imediata["depositos_totais_deflacionada_per_capita"])
